    ...
    for idx, line in enumerate(mutinfo):
        ...
        if Strand == "+":
            if js_chrom_hg19 in annotation and str(js_hg19) in annotation[js_chrom_hg19][js_strand_hg19]:
                ...
                numNonexp+=1
            if je_chrom_hg19 in annotation and str(je_hg19) in annotation[je_chrom_hg19][je_strand_hg19]:
...
if __name__ == "__main__":
    import sys
    File = "data/k1g_phase3_within_hg38.cass.exon.ext200_snps2cass_byEST_nonredundant_dataset.txt"
