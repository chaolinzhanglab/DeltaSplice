...
import json
import os
from deltasplice.constant import repdict, SeqTable, IN_MAP
...
def main():
    ...
    for species in Species:
        if os.path.exists(os.path.join(SavePath, "{}_pred".format(species))):
            continue
        with open(os.path.join(SavePath, "{}_pred".format(species)), "w") as f:
            f.write("start")
