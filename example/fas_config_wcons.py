...
class config:
    ...
    validjsonfile = None
    testjsonfile = None
    mut_data = [os.path.join("/temp/xuchencheng/eSplicedata/Species_37_ProcessedData/FAS_exon6/", x) for x in os.listdir("/temp/xuchencheng/eSplicedata/Species_37_ProcessedData/FAS_exon6/")]
    model = model
    epoch_num = 1
